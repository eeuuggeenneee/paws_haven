                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="text-center p-2 p-sm-3">
                                ...
                                <h4 class="mt-3 text-black">Our Mission</h4>
                                <p class="text-black mt-2 mb-0">is “Promote and maintenance of a safe, orderly and
                                    clean
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="text-center p-2 p-sm-3">
                                ...
                                <h4 class="mt-3 text-black">Our Vission</h4>
                                <p class="text-black mt-2 mb-0">“A God-loving community with participatory governance
    ...
    <section class="">
     ...
     style="width: 100%; height: 400px; object-fit: contain;">
                ...
                <div class="col-lg-6 offset-md-1 col-md-5">
                    <h3 class="fw-normal mt-3 text-black fw-bold">Mandalte</h3>
                    <p class="text-black mt-3" style="text-align: justify; line-height: 1.5;">
                        The Republic Act 7160 also known as the Local Government Code of
                        1991
            ...
            <div class="row pb-3 pt-5 align-items-center">
                <div class="col-lg-6 col-md-5 text-black">
                    ...
                    <div class="ms-3 mt-1">
                        ...
                        <p class="text-black"><i class="mdi mdi-circle-medium text-success"></i>
                        ...
                        <p class="text-black"><i class="mdi mdi-circle-medium text-success"></i> Ensure continuous
                            innovation, improvement and streamlining procedures of services being offered to better
                            serve the public;
                        </p>
                        <p class="text-black"><i class="mdi mdi-circle-medium text-success"></i> Serve the people
            ...
            defaultPoint: {
                ...
                annotation: {
                    ...
                    label: {
                        ...
                        text: '<br><span style="font-size:14px; color: black;"><b>%position</b><br>%name</span>'
                    }
                },
            },
            series: [{
