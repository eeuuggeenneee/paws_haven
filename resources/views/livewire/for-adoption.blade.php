            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-sm-12 ms-auto d-flex mb-1" wire:ignore>
                    ...
                    <div class="d-flex ms-auto">
                        ...
                        <input type="text" class="mt-3 form-control search" wire:model="changeName"  wire:keydown="changeStatus"  style="min-width:300px; height: 40px" placeholder="Search name,breed..." id="top-search">
                    </div>
