            ...
            <div class="row">
                            ...
                            <div class="list-group list-group-flush mt-2">
                                <a href="javascript:void(0);"
                                    class="list-group-item list-group-item-action text-primary border-0"><i
                                        class='uil uil-images me-1'></i> News Feed</a>
                                <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i
                                        class='uil uil-comment-alt-message me-1'></i> Messages</a>
                                <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i
                                        class='uil uil-calendar-alt me-1'></i> Events</a>
                                <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i
                                        class='uil uil-users-alt me-1'></i> Groups</a>
                                <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i
                                        class='uil uil-copy me-1'></i> Pages</a>
                            </div>
                        </div>
                    </div>
                    <!-- end profile info -->
                    ...
                    <div class="card">
                        <div class="card-body p-2">
                            <div class="list-group list-group-flush my-2">
                                <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i
                                        class='uil uil-calendar-alt me-1'></i> 3 events this week</a>
                                <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i
                ...
                <div class="col-xxl-6 col-lg-12 order-lg-2 order-xxl-1">
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <ul class="nav nav-tabs nav-bordered">
                                ...
                                <li class="nav-item">
                                    <a href="#story" data-bs-toggle="tab" aria-expanded="true"
                                        class="nav-link px-3 py-2">
                        ...
                        <div class="card-body pb-1">
                            <div class="d-flex">
                                ...
                                <div class="w-100">
                                    ...
                                    <p class="text-muted"><small>about 2 minuts ago <span class="mx-1">⚬</span>
                            ...
                            <div class="font-16 text-center text-dark my-3">
                                <i class="mdi mdi-format-quote-open font-20"></i> Leave one wolf alive and the sheep
                                are never safe. When people ask you
                            ...
                            <div class="my-1">
                                ...
                                <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted"><i
                                        class='uil uil-share-alt'></i> Share</a>
                            </div>
                            ...
                            <div class="mt-3">
                                <div class="d-flex">
                                    <img class="me-2 rounded" src="assets/images/users/avatar-9.jpg"
                                        alt="Generic placeholder image" height="32">
                                    <div>
                                        ...
                                        <div class="d-flex mt-3">
                                            <img class="me-2 rounded" src="assets/images/users/avatar-8.jpg"
                                                alt="Generic placeholder image" height="32">
                                            <div>
                    ...
                    <div class="card">
                        <div class="card-body pb-1">
                            <div class="d-flex">
                                <img class="me-2 rounded" src="assets/images/users/avatar-5.jpg"
                                    alt="Generic placeholder image" height="32">
                                <div class="w-100">
                                    <div class="dropdown float-end text-muted">
                                        <a href="#" class="dropdown-toggle arrow-none card-drop"
                                    ...
                                    <p class="text-muted"><small>20 min ago <span class="mx-1">⚬</span>
                                            <span>Public</span></small></p>
                                </div> <!-- end w-100-->
                            </div> <!-- end d-flex -->
                            ...
                            <div class="my-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <img src="assets/images/small/small-4.jpg" alt="post-img"
                                    ...
                                    <div class="col">
                                        ...
                                        <img src="assets/images/small/small-3.jpg" alt="post-img"
                            ...
                            <div class="mt-1 mb-1">
                                <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted ps-0"><i
                                        class='mdi mdi-heart text-danger'></i> 1.2k Likes</a>
                                <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted"><i
                                        class='uil uil-comments-alt'></i> 148 Comments</a>
                                <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted"><i
                                        class='uil uil-share-alt'></i> Share</a>
                            </div>
                            <hr class="m-0" />
