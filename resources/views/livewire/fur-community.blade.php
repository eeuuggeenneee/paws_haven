                            ...
                            <div class="card-body pb-1">
                                <div class="d-flex">
                                    ...
                                    <div class="w-100">
                                        ...
                                        <p class="text-muted">
                                            <small>{{ \Carbon\Carbon::parse($p['created_at'])->diffForHumans() }} <span
                                                    class="mx-1">⚬</span>
                                    ...
                                    <div class="d-flex mb-2">
                                        ...
                                        <div class="w-100">
                                            <div class="input-group">
                                                <input type="text" class="form-control border-1 form-control-sm"
                                                    wire:model="replycomment" placeholder="Write a comment">
                                                <a class="input-group-text"
                                                    wire:click="saveComment('{{ $p['post_id_unique'] }}')"
                                                    style="cursor: pointer;"> <i class="uil uil-envelope-send"></i>
