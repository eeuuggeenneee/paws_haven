            ...
            <div class="row">
                @foreach ($doglist as $d)
                    ...
                    <div class="col-md-6 col-xxl-3">
                        ...
                        <div class="card alert {{$outline}} bg-transparent text-primary">
                            <div class="py-1 px-1 mt-2">
                                ...
                                <div class="text-center">
                                    <a data-bs-toggle="modal" data-bs-target="#lostdog" wire:click="adoptionform('{{ $d['dog_id_unique'] }}')">
