<div>
    <div class="content">
        ...
        <div class="container-fluid" id="lost_found_list">
            <!-- start page title -->
            <div class="row">
                <div class="col-xl-3 col-sm-12 page-title-box">
                    <h4 class="page-title text-black mb-0">Lost and Found List</h4>
                </div>
                <div class="col-xl-9 col-sm-12 ms-auto d-flex mb-1" wire:ignore>
                    <nav class="d-none">
                    ...
                    <div class="d-flex ms-auto">
                        ...
                        <select class="form-select mt-3 me-3" style="max-width:300px; height: 40px" id="sortstatus" wire:model="statusC" wire:change="changeStatus">
                            <option selected="">Sort By Status</option>
                            <option value="Lost Dog">Lost Dog</option>
                            <option value="Found Dog">Found Dog</option>
                        </select>
                        
                        <input type="text" class="mt-3 form-control search" style=" height: 40px" wire:model="changeName"  wire:keydown="changeStatus" 
